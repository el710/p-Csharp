...
Console.WriteLine("There were friends who move to each other and dog run between them from one to another until friends met");
...
Console.Write("--- and what about the second one?: ");
